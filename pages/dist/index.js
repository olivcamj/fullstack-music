...
var songsData_1 = require("../prisma/songsData");
var hooks_1 = require("../lib/hooks");
var Home = function () {
    var _a = hooks_1.useMe(), user = _a.user, isLoading = _a.isLoading;
    var dataLoading = function () {
        if (isLoading) {
            return React.createElement(react_1.Skeleton, { height: "25px", width: "255px", marginBottom: "15px" });
        }
    };
        ...
        React.createElement(layout_1.Box, { color: "white", paddingX: "40px" },
            ...
            React.createElement(layout_1.Flex, null, songsData_1.artistsData.map(function (artist) { return (React.createElement(layout_1.Box, { paddingX: "10px", width: "20%" },
                React.createElement(layout_1.Box, { bg: "gray.900", borderRadius: "4px", padding: "15px", width: "100%" },
                    React.createElement(react_1.Image, { src: "https://placekitten.com/300/300", borderRadius: "100%" }),
                    React.createElement(layout_1.Box, { marginTop: "15px" },
                        React.createElement(layout_1.Text, { fontSize: "large" }, artist.name),
